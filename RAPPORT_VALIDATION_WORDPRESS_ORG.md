...
- [ ] **Uniformiser le text domain** : Utiliser `g2rd` (minuscules) partout
- [ ] **Supprimer/désactiver le système de licences** : Rendre le thème fonctionnel sans licence
...
- [ ] **Tester sans licence** : Vérifier que le thème fonctionne sans configuration de licence
- [ ] **Tester les mises à jour** : Vérifier que les mises à jour ne nécessitent pas de clé API
- [ ] **Supprimer proxy-g2rd-license.php** : Ou le rendre complètement optionnel
